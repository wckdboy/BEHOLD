...
class AddonLayoutTests(unittest.TestCase):
    def test_versions_agree(self) -> None:
        ...
        self.assertEqual(match.group(1), "1.4.0")
        ...
        self.assertIn("VERSION = (1, 4, 0)", _read(ADDON / "brand.py"))
    ...
    def test_stepper_url_documented(self) -> None:
        ...
        self.assertIn("chamfer", readme.lower())
        self.assertIn("Regenerate", readme)
        self.assertIn("tessellation", readme.lower())
        self.assertIn("First stable", readme)
        self.assertIn("Gobo", readme)
        self.assertIn("IES", readme)
        self.assertIn(".ies", readme.lower())
        self.assertIn("Blinds", readme)
        self.assertIn("Window", readme)
        self.assertIn("Circle", readme)
        self.assertIn("Square 1:1", readme)
        self.assertIn("Portrait 4:5", readme)
        self.assertIn("Landscape 16:9", readme)
        self.assertIn("2048", readme)
        self.assertIn("1080p", readme)
        self.assertIn("4K", readme)
        self.assertIn("Catcher", readme)
        self.assertIn("ground contact", readme.lower())
        self.assertIn("shadow catcher", readme.lower())
        self.assertIn("EEVEE", readme)
        self.assertIn("Draft = EEVEE", readme)
        self.assertIn("Catalog", readme)
        self.assertIn("Dramatic", readme)
        self.assertIn("vignette", readme.lower())
        self.assertIn("Batch export", readme)
        ...
        self.assertIn("Link Selected", readme)
        self.assertIn("Solo product", readme)
        self.assertIn("light linking", readme.lower())
        self.assertIn("DoF", readme)
        self.assertIn("f-stop", readme)
