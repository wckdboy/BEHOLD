...
class AddonLayoutTests(unittest.TestCase):
    def test_versions_agree(self) -> None:
        ...
        self.assertEqual(match.group(1), "0.25.0")
        self.assertIn('"version": (0, 25, 0)', init)
        self.assertIn('"blender": (4, 2, 0)', init)
        self.assertIn('blender_version_min = "4.2.0"', manifest)
        self.assertIn("AMIRITE.studio", init)
        self.assertIn("VERSION = (0, 25, 0)", _read(ADDON / "brand.py"))
    ...
    def test_stepper_url_documented(self) -> None:
        ...
        self.assertIn("0.19.0", readme)
        self.assertIn("0.21.0", readme)
        self.assertIn("0.20.0", readme)
        self.assertIn("0.22.0", readme)
        self.assertIn("0.23.0", readme)
        self.assertIn("0.24.0", readme)
        self.assertIn("0.25.0", readme)
