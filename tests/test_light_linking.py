...
class WiringTests(unittest.TestCase):
    ...
    def test_lights_card_stays_off_empty_state(self) -> None:
        ...
        self.assertIn('text="Link Selected"', linking)
        self.assertIn('text="Unlink"', linking)
        self.assertIn('text="Solo product"', linking)
        self.assertIn("light_linking_kind", linking)
        self.assertNotIn("behold.exclude_selected", linking)
        empty_idx = body.index("draw_empty_card")
        self.assertLess(empty_idx, body.index("draw_lights_linking"))
