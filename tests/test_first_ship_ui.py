...
class FirstShipUiTests(unittest.TestCase):
    ...
    def test_lights_section_has_inventory_and_draw_target(self) -> None:
        ...
        self.assertIn("light_linking_kind", linking)
    ...
    def test_shoot_first_ship_is_draft_final_look_shots_batch_and_turntable(self) -> None:
        ...
        self.assertNotIn('text="Render"', body)
        self.assertIn("draw_look_compact", body)
        self.assertIn("draw_exposure_compact", body)
        ...
        self.assertLess(body.index("draw_exposure_compact"), body.index("draw_look_compact"))
        self.assertLess(body.index("draw_look_compact"), body.index("draw_shots_compact"))
        ...
        exposure = _func_source(self.source, self.tree, "draw_exposure_compact")
    ...
    def test_parked_draw_keeps_mixer_batch_and_materials(self) -> None:
        ...
        self.assertIn("behold.cleanup_cad", parked_import)
        self.assertIn("Apply cleanup", parked_import)
