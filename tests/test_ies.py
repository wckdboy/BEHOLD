...
class IesWiringTests(unittest.TestCase):
    def test_apply_module_wires_the_spec(self) -> None:
        ...
        self.assertNotIn("apply_gobo_to_object", source)
    ...
    def test_shape_apply_does_not_reapply_ies_or_gobo(self) -> None:
        ...
        self.assertNotIn("release_ies_if_active", src)
        self.assertNotIn("apply_ies_in_scene", src)
    ...
    def test_panel_ies_card_stays_off_empty_state(self) -> None:
        ...
        self.assertIn("light_ies_strength", ies)
        self.assertIn("light_ies_scale", ies)
        self.assertIn("behold.load_ies", ies)
        self.assertIn("behold.clear_ies", ies)
        self.assertIn("behold.load_ies_sample", ies)
        self.assertIn('text="IES"', ies)
        empty_idx = body.index("draw_empty_card")
        self.assertLess(empty_idx, body.index("draw_lights_ies"))
